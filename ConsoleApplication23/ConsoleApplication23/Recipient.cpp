...
void  Recipient::Register() // registeration Function
{
...
void Recipient::Login() // Login function
{ 
	...
	for (int i = 0; i < recipients_password.capacity(); i++) {
...
void Recipient::search_for_blood() {
	...
	if (flag3 != 1) { // if blood type not exist
		cout << "Unfortunately, there is no available blood type like the one you want...\n\n";
	}
	cout << "                                  -------------------------------------------------\n";
	cout << "                                  | 1- Requast blood type and quantity you want   |\n";
	cout << "                                  | 2- Back to menue                              |\n";
